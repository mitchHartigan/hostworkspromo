...
const referralsData = {
  ...
  description:
    "These products are passed along. Nearly asdftwo-thirds are given away after the original recipient is finished using the item. They are proven to add value to your guests stay and influence positive referals and reviews.",
